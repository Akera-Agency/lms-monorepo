...
export function AuthForm({
    ...
    return (
        <form onSubmit={handleAuth} className={cn(`flex flex-col ${!passwordInput? 'gap-12' : 'gap-6'}`, className)} {...props}>
            ...
            <div className="grid grid-cols-2 gap-4">
                {providers?.map((provider) => (
                    <Button key={provider.name} variant="outline" type="button" className="w-full" onClick={() => handleOAuthSignUp(provider.name)}>
