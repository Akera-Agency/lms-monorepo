...
export function Navbar() {
  ...
  return (
    <div className="flex justify-center">
      <nav className="z-20 hidden sm:flex w-[600px] py-4 px-6 text-white text-md font-medium items-center justify-between fixed top-7 bg-neutral-950/40 backdrop-blur-lg rounded-xl border border-neutral-700">
      ...
      {menuOpen && (
        <div className="sm:hidden fixed top-20 left-0 w-full bg-neutral-950/95 backdrop-blur-xl border-y border-neutral-700 p-6 z-20 animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          <NavLinkList
          linkStyle='hover:text-[#F3562E] transition-colors'
        ...
        />
            <Button
              variant="default"
              className="w-full mt-4 text-md rounded-md bg-[#F3562E] hover:bg-transparent border border-[#F3562E] hover:text-[#F3562E]"
              onClick={handleSignOut}
            >
              Sign out
            </Button>
