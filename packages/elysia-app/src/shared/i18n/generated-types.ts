...
export type ErrorsKeys =
  ...
  | 'notification_failed'
  | 'unauthorized_tenant'
  | 'invalid_permissions_structure'
  | 'cannot_modify_system_roles'
  | 'cannot_delete_system_roles'
  | 'failed_to_send_email'
  | 'failed_to_load_email_template'
...
export type MessagesKeys =
  ...
  | 'user.logout_successful'
  | 'user.registration_successful'
  ...
  | 'api.rate_limit_warning'
  | 'api.deprecated_endpoint'
  | 'api.version_mismatch'
  | 'api.feature_flag_disabled'
  | 'email.sent'
  | 'email.delivered'
  | 'email.bounced'
  | 'email.failed'
...
export type AllTranslationKeys = CommonKeys | ErrorsKeys | ValidationKeys | MessagesKeys;
